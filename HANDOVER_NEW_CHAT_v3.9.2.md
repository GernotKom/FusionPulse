# FusionPulse – Übergabe für neuen Chat · v3.9.2 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.9.2.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **20 Suiten, alle grün**
