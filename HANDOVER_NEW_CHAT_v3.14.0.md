# FusionPulse – Übergabe für neuen Chat · v3.14.0 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.14.0.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **26 Suiten, alle grün**
