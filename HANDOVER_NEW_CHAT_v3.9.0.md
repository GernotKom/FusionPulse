# FusionPulse – Übergabe für neuen Chat · v3.9.0 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.9.0.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **18 Suiten, alle grün**
