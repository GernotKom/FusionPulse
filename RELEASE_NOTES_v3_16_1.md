# FusionPulse v3.16.1 · Modus A ohne Kauf-Freigabe (Variante 2) + Terminmaske nachgewiesen
...
35 Testsuiten grün in zwei Zeitzonen, vier SHA-Blöcke unabhängig nachgerechnet,
...
- 35 Suiten grün, `TZ=Europe/Vienna` und `TZ=America/Chicago`
