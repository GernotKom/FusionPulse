# FusionPulse – Übergabe für neuen Chat · v3.10.0 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.10.0.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **22 Suiten, alle grün**
