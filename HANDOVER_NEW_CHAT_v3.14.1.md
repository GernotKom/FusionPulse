# FusionPulse – Übergabe für neuen Chat · v3.14.1 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.14.1.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **27 Suiten, alle grün**
