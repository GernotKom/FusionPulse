# FusionPulse – Übergabe für neuen Chat · v3.12.0 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.12.0.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **24 Suiten, alle grün**
