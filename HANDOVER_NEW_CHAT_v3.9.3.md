# FusionPulse – Übergabe für neuen Chat · v3.9.3 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.9.3.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **21 Suiten, alle grün**
