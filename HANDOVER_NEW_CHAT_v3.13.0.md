# FusionPulse – Übergabe für neuen Chat · v3.13.0 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.13.0.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **25 Suiten, alle grün**
