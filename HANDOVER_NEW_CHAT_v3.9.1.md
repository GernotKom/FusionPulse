# FusionPulse – Übergabe für neuen Chat · v3.9.1 (Claude/Opus-Strang)
...
- Aktuelles Archiv: `FusionPulse_v3.9.1.zip`
...
- Tests: `npm run check` bzw. `node tests/safety-regression.mjs` → **19 Suiten, alle grün**
